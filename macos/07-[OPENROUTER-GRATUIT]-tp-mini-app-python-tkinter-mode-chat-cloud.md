# 07 — TP mini-app Python/Tkinter sur **macOS** : OpenClaude + OpenRouter (mode chat, cloud gratuit)

> **Public** : étudiants débutants en Python.
> **Coût** : 100 % gratuit (modèles `:free` d'OpenRouter).
> **OS** : macOS (Apple Silicon ou Intel).
> **Durée** : 1 h.
> **Avantage clé** : pas de pression sur ta RAM unifiée, modèles plus puissants que ce que tu peux faire tourner sur ton Mac.
> **Pré-requis** :
...
> - Le résultat de l'IA est **bien meilleur** ici si tu as un Mac d'entrée de gamme.
...
### Bonus macOS — stocker dans le trousseau

```bash
security add-generic-password -a "$USER" -s openrouter -w "sk-or-v1-..."
# Récupération dans ton .zshrc :
...
|----------|-------|-----------|
| `401 Unauthorized` | Clé API absente/erronée | `echo $OPENAI_API_KEY` ; régénère sur [openrouter.ai/keys](https://openrouter.ai/keys) |
